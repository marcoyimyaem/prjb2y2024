...
public class LambdaLesson {
    static void print(List<Animal2> animal2s, CheckTrait2 check){
        for(Animal2 animal2 : animal2s){
            if(check.test(animal2)){
...
class Animal2 {
    ...
    private int age;
    public Animal2(String speciesName, boolean hopper, boolean swimmer, int age) {
    species = speciesName;
    canHop = hopper;
    canSwim = swimmer;
    this.age = age;
